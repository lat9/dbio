...
$define = [
    ...
    'DBIO_PRODUCTSOPTIONSVALUES_DESCRIPTION' => 'This report-format supports import/export of <b>all</b> fields within the <code>products_options_values</code> table.  Use this report to add or change information about your store\'s product options\' values. One record in the DbIo CSV corresponds to one <em>language-specific</em> product option value.' .
    '<br><br>' .
    '<b>Notes:</b>' .
    '<ol>' .
