  ...
  function perform ($tableName, $tableData, $performType='INSERT', $performFilter='', $debug=false) {
    switch (strtolower($performType)) {
      ...
      if ($debug === true) {
        echo $insertString;
        die();
//-bof-20160203-lat9-Additional debug option ('return')  *** 1 of 2 ***
      } elseif ($debug === 'return') {
        return $insertString;
//-eof-20160203-lat9-Additional debug option ('return')  *** 1 of 2 ***
      } else {
      ...
      if ($debug === true) {
        echo $updateString;
        die();
//-bof-20160203-lat9-Additional debug option ('return')  *** 2 of 2 ***
      } elseif ($debug === 'return') {
        return $updateString;
//-eof-20160203-lat9-Additional debug option ('return')  *** 2 of 2 ***
      } else {
